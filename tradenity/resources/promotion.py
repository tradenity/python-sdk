...
class Promotion(object):
    ...
    @property
    def meta(self):
        """Gets the meta of this Promotion.


        :return: The meta of this Promotion.
        :rtype: InstanceMeta
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this Promotion.


        :param meta: The meta of this Promotion.
        :type: InstanceMeta
        """
    ...
    @property
    def begins_at(self):
        """Gets the begins_at of this Promotion.


        :return: The begins_at of this Promotion.
        :rtype: datetime
        """
    ...
    def begins_at(self, begins_at):
        """Sets the begins_at of this Promotion.


        :param begins_at: The begins_at of this Promotion.
        :type: datetime
        """
    ...
    @property
    def ends_at(self):
        """Gets the ends_at of this Promotion.


        :return: The ends_at of this Promotion.
        :rtype: datetime
        """
    ...
    def ends_at(self, ends_at):
        """Sets the ends_at of this Promotion.


        :param ends_at: The ends_at of this Promotion.
        :type: datetime
        """
    ...
    @property
    def include(self):
        """Gets the include of this Promotion.


        :return: The include of this Promotion.
        :rtype: ItemsSelector
        """
    ...
    def include(self, include):
        """Sets the include of this Promotion.


        :param include: The include of this Promotion.
        :type: ItemsSelector
        """
    ...
    def find_one_by(cls, **kwargs):
        results = cls.list_all_promotions(**kwargs)
        if len(results) > 0:
            return results[0]
    ...
    @classmethod
    def _list_all_promotions_with_http_info(cls, **kwargs):
        """List Promotions

        Return a list of Promotions
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_all_promotions_with_http_info(async=True)
        >>> result = thread.get()
